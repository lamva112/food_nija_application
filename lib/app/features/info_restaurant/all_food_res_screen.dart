...
class RestaurantAllFoodScreen extends StatefulWidget {
  final String ResId;
  const RestaurantAllFoodScreen({Key? key, required this.ResId})
      : super(key: key);

  @override
  State<RestaurantAllFoodScreen> createState() =>
      _RestaurantAllFoodScreenState();
}

class _RestaurantAllFoodScreenState extends State<RestaurantAllFoodScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Food> allProducts = foodsProvider.searchFoodByResId(widget.ResId);
    return Scaffold(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: TextFormField(
                            ...
                            onChanged: (valuee) {
                              setState(() {
                                listProdcutSearch = foodsProvider
                                    .searchQueryFoods(allProducts, valuee);
                              });
                            },
                          ),
                        ),
